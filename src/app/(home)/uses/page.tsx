...
export const metadata: Metadata = {
  ...
  description: "Liste des outils que j'utilise pour travailler, apprendre et me divertir",
};
...
export default function UsesPage() {
  ...
  return (
    <Container className="mb-16">
      <Heading variant="h2" className="font-griffiths italic">
        Mes outils
      </Heading>
      <p className="text-slay-700/75 dark:text-slay-300/75 my-2 w-3/4 ">
        Liste de mes outils préférés que j'utilise pour travailler, apprendre et me divertir. J'essaie de les mettre à
        jour régulièrement.
      </p>
