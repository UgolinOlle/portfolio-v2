...
// --- Header Variants
const headingVariants = cva(' font-semibold font-griffiths', {
  variants: {
    variant: {
      hero: 'lg:text-8xl md:text-7xl text-6xl font-light leading-[110%] tracking-[6%]',
      h1: 'lg:text-6xl md:text-5xl text-3xl font-bold text-neutral-900 dark:text-neutral-200 leading-[110%] tracking-[6%]',
      h2: 'lg:text-4xl md:text-4xl text-2xl font-semibold text-neutral-900 dark:text-neutral-200 leading-[110%] tracking-[6%]',
      h3: 'lg:text-2xl md:text-2xl text-xl font-semibold text-neutral-900 dark:text-neutral-200 leading-[110%] tracking-[6%]',
      h4: 'lg:text-xl md:text-xl text-lg font-semibold text-neutral-900 dark:text-neutral-200',
    },
    align: {
